...
export function NewsletterEmbed({ src, title }: NewsletterEmbedProps) {
  return (
    <Taped rotate={3} tapes={[{ position: "top-left", rotate: -8, width: 76 }, { position: "top-right", rotate: 9, width: 76 }]}>
